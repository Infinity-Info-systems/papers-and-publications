...
| Item | Type | Status |
| --- | --- | --- |
| MCGR Framework Paper | SSRN | Published |
| FinOps Governance Paper | SSRN | Draft |
...
- [SSRN README](../ssrn/README.md)
- [Conference Submissions README](../conference-submissions/README.md)
